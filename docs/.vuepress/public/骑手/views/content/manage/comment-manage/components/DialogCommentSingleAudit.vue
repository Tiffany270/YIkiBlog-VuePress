<template>
  <dialog-container
    class="dialog-comment-single-audit"
    :ref="DIALOG_REF"
    title="审核"
    width="500px"
    @closed="resetDialog"
  ...
  >
    <page-container>
      <div class="">
        <block-container>
          <div class="dialog-single-audit-title page-content">
            <template>
              审核结果：
    ...
    <template v-slot:footer class="el-dialog__footer center-button">
      <el-button type="primary" @click="confirmSingleCommentEdit">
        确认
      </el-button>
...
export default {
  name: 'DialogCommentSingleAudit', // 评论单条审核
  props: [],
  inject: ['fatherMethod'],
  components: {},
