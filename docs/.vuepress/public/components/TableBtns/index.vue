<template>
  <div class="table-btns">
    <template v-if="filteredList.length > showNums">
      <el-button
      ...
      <el-dropdown>
        <el-button style="padding: 5px">
          <i class="iconfont xbicon-page" style="font-size: 18px; font-weight: 600"></i>
        </el-button>
...
export default {
  ...
  computed: {
    filteredList() {
      return this.config.filter(item => (item.permission !== undefined ? item.permission : true))
    },
    dropDownList() {
      return {
