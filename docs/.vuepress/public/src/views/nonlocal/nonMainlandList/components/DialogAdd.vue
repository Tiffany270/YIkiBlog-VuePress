<template>
  <dialog-container :ref="DIALOG_REF" title="新增" width="750px">
    <template>
...
import { insertNonMainland } from '@/apis/signManage'
    ...
    save() {
      this.$refs.form.validate(async valid => {
        if (valid) {
          ...
          insertNonMainland({ ...this.form, certImg: certImg.join(',') }).then(() => {
